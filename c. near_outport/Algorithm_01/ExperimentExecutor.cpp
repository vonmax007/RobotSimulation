...
void ExperimentExecutor::exec()		//实验主循环界面;
{
	...
	//	cout << "\t\n\t***** Welcome to Robot simulation main Interface *****  \n\n";
	//	cout << "\t(1): Run Single-Load Single-direction-road Simulation \n";
	//	cout << "\t(2): Run Single-Load Double-direction-road Simulation \n";
	//	cout << "\t(3): Run Multi-Load Simulation \n";
	//	cout << "\t(q): Quit Experiment \n";
	//	cout << "\n\tPlease input here: ";
	//	cin >> input;

	//cout << "\n\tThank you for using our experiments !!!\n\n\n";
}
